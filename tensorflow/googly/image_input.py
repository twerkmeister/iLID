...
# https://github.com/tensorflow/tensorflow/blob/1c57936/tensorflow/models/image/cifar10/cifar10_input.py

"""Routine for decoding our spectrogram binary file format."""
...
def distorted_inputs(data_dir, batch_size):
  ...
  Returns:
    ...
    labels: Labels. 1D tensor of [batch_size] size.
  """
  filenames = [os.path.join(data_dir, 'data_batch_%03d.bin' % i)
               for i in xrange(0, TRAIN_DATA_BATCHES)]
  for f in filenames:
  ...
  # TODO: evaluate possible distortions
  distored_image = reshaped_image
...
def inputs(eval_data, data_dir, batch_size):
  ...
  if not eval_data:
    ...
    filenames = [os.path.join(data_dir, 'test_batch_%03d.bin' % i)
                 for i in xrange(0, TEST_DATA_BATCHES)]
